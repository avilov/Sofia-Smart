...
<div class="work editWindow">
                        <form action="" method="post">
                            ...
                            <div id="lang_ru" class="language">
                                <label>Menu_RU</label><input type="text" name='menu_ru' value='<?=$data['menu_ru'];?>' placeholder="меню ру"><pre></pre>
                            ...
                            <div id="lang_ua" class="language">
                                <label>Menu_UA</label><input type="text" name='menu_ua' value='<?=$data['menu_ua'];?>' placeholder="меню ру"><pre></pre>
                            ...
                            <label>View:</label><input type="text" name='view' value='<?=$data['view'];?>' style="width: 500px;"><pre></pre>
                            <label>Page:</label><input type="text" name='page' value='<?=$data['page'];?>' style="width: 500px;"><pre></pre>
                            <label>Мaterial:</label><input type="text" name='material' value='<?=$data['material'];?>' style="width: 500px;"><pre></pre>
                            <h1>Подключаемые секции к страницам</h1><pre></pre>
                            <? $i=1; while ($i <= 10) {?>
                            <label>Секция <?=$i;?>:</label><select size="1" name="section<?=$i;?>" <? if($i == 1) {?>required<?}?>>
                                <option value="<?=$data['section'.$i];?>"><?=$data['section'.$i];?></option>
                                <option value=""></option>
